...
import { Scale, FileText, GitCompare, Bot, Zap, Shield, Clock, Target, CheckCircle, ArrowRight, Users, TrendingUp, Award, MessageCircle } from 'lucide-react';
import Link from 'next/link';

export default function LegalAIHomePage() {
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="relative container mx-auto px-4 py-16 md:py-24">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <Button size="lg" className="bg-white text-blue-700 hover:bg-blue-50 px-8 py-3" asChild>
                <a href="#try-tools">
      ...
      <div className="py-16" id="try-tools">
        <div className="container mx-auto px-4">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-center py-12">
                      ...
                      <h3 className="text-xl font-semibold mb-4">Advanced Legal AI Chat</h3>
                      <p className="text-gray-600 mb-6 max-w-md mx-auto">
                        Experience our full-featured AI chat assistant with advanced reasoning capabilities for complex legal queries.
                      </p>
