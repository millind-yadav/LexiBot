...
function PureMultimodalInput({
  ...
  return (
    <div className="flex relative flex-col gap-4 w-full">
      ...
      <PromptInput
        className="rounded-2xl border border-blue-100 bg-white/95 p-3 text-slate-900 shadow-md transition-all duration-200 focus-within:border-blue-300 hover:border-blue-200"
        onSubmit={(event) => {
